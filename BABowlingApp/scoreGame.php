    ...
    <body>
        ...
        <div class=" justify-content-center"> 
            <div class="col-2">
                ...
                <p id="game" class="mb-0">Game:1</p>
                <p id="round" class="mb-0">Round:Qualifier</p>
...
<!--        <div class="justify-content-center"> 
            ...
            <div class="col-8">
                ...
                <input  class="ballScore"id="ballScore" name="ballScore" type="text" pattern="^[0-9 \/ X x]" maxlength="1"> <button id="enterBall" class="rounded mr-2">Enter</button><button id="undoBall" class="rounded" disabled>Undo</button>
                <br>
